...
const BestSellersScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        setBestSellers(booksData.books.filter(book => book.best_seller === "1"));
    }, []);
    ...
    return (
        <View style={styles.container}>
            ...
            />
            <BottomNavigation navigation={navigation} currentRoute="BestSellers" style={styles.bottomNavigation} />
        </View>
    );
};
